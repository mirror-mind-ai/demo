...
No perfil de cada membro, mostrar "Última vez online: há X minutos /
horas / dias", calculado a partir do último request autenticado.

## Status

Story aberta, plano ainda não escrito. Próximo passo: entrar em modo
plano, desenhar a abordagem, registrar em `plan.md` antes de tocar no
código.
